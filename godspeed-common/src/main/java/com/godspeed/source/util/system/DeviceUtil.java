...
import com.godspeed.source.util.io.LogUtil;
...
//        Log.d(TAG, "------The Device Display Size-------:" + displaySize + "--width:"+width + "--height:"+height);
    ...
    public static String getImei() {
        TelephonyManager tm = (TelephonyManager) GodspeedContext.context.getSystemService(Context.TELEPHONY_SERVICE);
        return tm.getDeviceId();
    }

    public static float getDensity() {
        DisplayMetrics displayMetrics = GodspeedContext.context.getResources().getDisplayMetrics();
    ...
    public static int getVersionCode() {
        PackageManager manager = GodspeedContext.context.getPackageManager();
    ...
    static public String getUDID() {
        if (uuid == null) {
            synchronized (GodspeedContext.context) {
                if (uuid == null) {
                    final SharedPreferences prefs = GodspeedContext.context.getSharedPreferences(PREFS_FILE, 0);
                    ...
                    if (id != null) {
                        ...
                        final String androidId = Settings.Secure.getString(GodspeedContext.context.getContentResolver(), Settings.Secure.ANDROID_ID);
                        ...
                        try {
                            if (!"9774d56d682e549c".equals(androidId)) {
                                ...
                                final String deviceId = ((TelephonyManager) GodspeedContext.context.getSystemService(Context.TELEPHONY_SERVICE)).getDeviceId();
