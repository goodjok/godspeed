...
public abstract class DaggerRecyclerViewFragment<T> extends DaggerFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    protected DaggerRecylerViewAdapter mAdapter;
    ...
    public   void initWidget(View view) {
        ...
        if (showDivider()) {
            baseRecyclerView.addItemDecoration(new RecycleViewDivider(getActivity(), getOrientation()));
        }
    ...
    protected void getData(int page, int state) {
        isLoading = true;
    ...
    protected abstract DaggerRecylerViewAdapter getAdapter();
    ...
    public final DaggerRecylerViewAdapter getParentAdapter() {
        return mAdapter;
    }
